...
def load_reference(path=None):
    ...
    if path is None:
        candidates = [
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "reference_font.ttf"),
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "reference_font.ttf"),
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "voter_suvidha", "reference_font.ttf"),
            os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "voter_suvidha", "reference_font.ttf"),
            r"c:\Users\Indrajeet\Documents\antigravity\serene-nobel\voter_suvidha\reference_font.ttf",
            r"C:\Users\Indrajeet\Downloads\Voter_Suvidha_Portable\Voter_Suvidha\voter_suvidha\reference_font.ttf",
            r"C:\Users\Indrajeet\Downloads\Voter_Suvidha_Portable11\Voter_Suvidha\voter_suvidha\reference_font.ttf"
        ]
        for c in candidates:
            if os.path.isfile(c):
                path = c
